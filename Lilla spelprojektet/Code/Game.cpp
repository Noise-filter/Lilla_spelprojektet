...
bool Game::init(HINSTANCE hInstance, int cmdShow)
{
	...
	ParticlePolicy* temp = pSystem->addTrail(D3DXVECTOR3(1, 1, 1), D3DXVECTOR3(0, 0, 0), 10, 100, 1, 1, 1, 1);
	ParticlePolicy* temp2 = pSystem->addTrail(D3DXVECTOR3(0, 1, 0), D3DXVECTOR3(100, 0, 100), 10, 100, 1, 1, 1, 1);
	
	pSystem->removePolicy(temp);
